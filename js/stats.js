...
div.innerHTML =
    ...
    <div style="color: white">
        <div class="statsNumbers">
            <svg width="2.2em" height="2.2em" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z"></path></svg>
            <h5>
                You opened Sky on <em> ` + generatedData.daysSkyOpened + ` </em> distinct days
            </h5>
        </div>
        <div class="statsNumbers">
            <svg width="2.2em" height="2.2em" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
            <h5>
        ...
        <div class="statsNumbers">
            <svg width="2.2em" height="2.2em" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
            <h5>
                Your longest play session lasted <em> ` + millisecondsToTime(generatedData.maxMillisecondsOnADay) + ` </em>
            </h5>
        </div>
        <div class="statsNumbers">
            <svg width="2.2em" height="2.2em" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            ...
            <h5>
                Your longest play streak was <em> ` + (new Intl.NumberFormat()).format(generatedData.longestPlayStreak) + ` </em> days in a row
            </h5>
        </div>
    </div>
    `;
